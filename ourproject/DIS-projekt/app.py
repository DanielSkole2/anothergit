...
DB_CONFIG = {
    ...
    "dbname": "postgres",
    "user": "postgres",
    "password": "useyouyractualpassword",
    "host": "localhost",
    "port": "5432"
}
...
def calculate():
    ...
    if not re.match(r"^(Male|Female|Other)$", gender):
        return render_template("index.html", result="Invalid Gender")
    
    if not re.match(r"^(1[6-9]|2[0-5])$", age):
        return render_template("index.html", result="Invalid Age")
    ...
    try: 
        ...
        if row and row[0] is not None:
            ...
            return render_template("index.html", result="No matching")
